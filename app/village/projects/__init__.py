...
# TODO: All
# TODO: Not sure how to easily parse out village name here as it can be partially / totally covered by the list
# TODO: Remember to try out a long character name during the parse as they take up to two lines
# TODO: Only parse the most recent rank - ignore the others since they fade away into oblivion?
class Projects:
